...
Afterwards go ahead and install JavaScript as well.<br>
...
*hint: it's not magic, just read the documentation :)*
...
*note: delete the original nav (as we no longer need it).*
